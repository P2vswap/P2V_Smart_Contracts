...
╚═╝░░░░░╚══════╝░░░╚═╝░░░  ░░░╚═╝░░░░╚════╝░╚═╝░░╚═╝╚══════╝╚═╝░░╚══╝
 ...
 Deflationary, multi cross-chain, 
 Token, issued on Ethereum Mainnet (ERC20) and Binance smart chain (BEP20-BSC), 
 Developing with a total of 7% of every buy or sell. 
 Governance of P2VSWAP.io DExchanger's Platform.
 Created by Noah Smyth and Unicode.
...
contract P2VToken is Context, IERC20, Ownable {
    ...
    constructor (string memory _NAME, string memory _SYMBOL, uint256 _DECIMALS, uint256 _supply, uint256 _txFee,uint256 _lpFee,uint256 _DexFee,address routerAddress,address feeaddress)  {
        _name = _NAME;
        _symbol = _SYMBOL;
        _decimals = _DECIMALS;
    ...
    function _getCurrentSupply() private view returns(uint256, uint256) {
        ...
        return (rSupply, tSupply); // Unicode was here
    }
    ...
    function _transferToExcluded(address sender, address recipient, uint256 tAmount) private {
        ...
        _takeDev(tDev);
        _reflectFee(rFee, tFee);
        emit Transfer(sender, recipient, tTransferAmount); //Noah Smyth was here
    }
